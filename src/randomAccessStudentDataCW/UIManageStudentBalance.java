...
public class UIManageStudentBalance {
	...
	public static void main(String[] args) {
		...
		try {
			// process student 1
			System.out.println("Student 1 balance: "
					+ studBalances.getStudentBalance(1));
			studBalances.addToStudentBalance(1, 100.00);
			System.out.println("Student 1 balance after added 100 "
					+ studBalances.getStudentBalance(1));
			// process student 3
			System.out.println("Student 3 balance: "
					+ studBalances.getStudentBalance(3));
			studBalances.addToStudentBalance(3, 300.00);
			System.out.println("Student 3 balance after added 300 "
					+ studBalances.getStudentBalance(3));

			// process student 2
			System.out.println("Student 2 balance: "
					+ studBalances.getStudentBalance(2));
			studBalances.payStudentBalance(2, 200.00);
			System.out.println("Student 2 balance after paid 200 "
					+ studBalances.getStudentBalance(2));
			// close the files
